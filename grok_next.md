...
5. **T4b** — классы 1 и 2 ПОСАЖЕНЫ (`b5a2cf9` и formal binding, `steps/walk-methods-t4b.md`, harness 400/400, дифф 216/216). **Следующий код — класс 3** (own-поле во вложенном теле), со свидетелем связывания внутри ветки (ANSWER 201b2af-2). Throws и callable-формалы ждут своего места.
