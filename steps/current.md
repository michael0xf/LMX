...
- Начинать с [work_chat/README.md](../work_chat/README.md): все сочетания агентов и команды. Исправление по пользователю: BOT-REVERSE-84261 получил ACK лишь после ручного пинга Bot. Webhook wake подтверждён, автоматический ответ не доказан. Текст handler для routine подготовлен в инструкции, но ещё не применён.
