...
- Открытые вопросы — `LMX_blog/q/current/`: [q31](LMX_blog/q/current/q31.md) (тот же вызов в теле файла `.lm2` и внутри `fn`), [q32](LMX_blog/q/current/q32.md) (раскладка `Lmx`). Изменение фактов harness, вызванное нормой, а не дефектом.
