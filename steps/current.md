...
- Каждую реплику автора обязательно сначала дословно сохранять строго в `blog/`, без отбора и до выполнения поручения. Порядок поступления, опечатки и исходный доступный текст сохранять. Полные правила и карта проекта — в корневом `READ.ME`; они обязательны для всех моделей.
- Журнал начат с трёх последних реплик об устройстве спецификаций. Прежняя переписка целиком ещё не перенесена; не выдавать эту подборку за полный архив.
