...
10. **Запись `Lmx` уже `{parent, len, @: void data, native}`** (`dev/l2src_sandbox/lmx.h.lm1`). [q32](LMX_blog/q/current/q32.md) снят: миграции нет.
...
- Открытые вопросы — `LMX_blog/q/current/`: [q31](LMX_blog/q/current/q31.md) отвечен: три пункта в плане ядра, [q32](LMX_blog/q/current/q32.md) снят: запись `Lmx` уже в исходнике. Изменение фактов harness, вызванное нормой, а не дефектом.
