...
- Открытые вопросы — `LMX_blog/q/current/`: [q31](LMX_blog/q/current/q31.md) (адрес и нечисловой вход в корне), [q32](LMX_blog/q/current/q32.md) (раскладка `Lmx`). Изменение фактов harness, вызванное нормой, а не дефектом.
