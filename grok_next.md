...
5. **T4b** — классы 1–3 ПОСАЖЕНЫ (`b5a2cf9`, formal binding, класс 3 `steps/walk-methods-t4b.md`). **D-79 ПОСАЖЕН (F-70):** поле заводит только объявление; голая запись формала — ячейка метода, в том числе из `if`. `keep(3)` = 4. BLOCK 3f68f41 снят этим срезом. Throws и callable-формалы ждут своего места. Дальше — п.6.
