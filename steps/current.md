...
- По запросу автора создан отдельный CLI-мост LMX; состояние, команды и ограничения — в [claude-bridge.md](claude-bridge.md). Следующий шаг: подключить авторизацию и проверить два связанных запроса. Два агента проекта L1 не затрагивать.
