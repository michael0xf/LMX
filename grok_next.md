...
4. **-200 POSIX-двойник** — срезы (а), (б) и остаток REVIEW b5e72d7 ПОСАЖЕНЫ на машине (`steps/posix-200.md`: `lmx_manager_running_lane_ended` / `pause_ms`, build 280/280). Облачный 232/232 и L3 11/11 ещё число fable, не повторять посадку. Дальше — п.5.
