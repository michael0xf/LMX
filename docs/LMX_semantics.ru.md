...
- [28. Обычные вызовы LMX через Message-транспорт: `post` и ожидания ответов](#thread-message-api)
...
## 28. Обычные вызовы LMX через Message-транспорт: `post` и ожидания ответов
