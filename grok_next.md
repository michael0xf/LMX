...
4. **-200 POSIX-двойник** — срезы (а), (б), lane и селфтесты п.1–п.2 ПОСАЖЕНЫ (`5bc8ec7`, `e8daf3a`). REVIEW e8daf3a п.1–п.5 закрыты этим срезом: `LmxManagerThread` в `lmx_posix_abi.h.lm1`, `<stdlib.h>` в POSIX-теле, после close хэндл lane не читается, `EEXIST` у `mkdir` — успех; п.4 принят (`0192548`). Машина: l1trans + `gcc -c -pthread`, build 280/280 (`build/l2src/20260925_144603`), harness 400/400 (`build/l2_harness/20260925_144901`), L3 11/11, имена 69/128. Облако 232/233 снимет fable. **Следующий код — D-78** (`steps/defect-d78.md`), отдельно. **Облако fable на `8cb73b0`: `build_l2src.py` 232/233 (красный только D-78), L3 11/11 — REVIEW 8cb73b0.**
5. **T4b** — классы 1 и 2 ПОСАЖЕНЫ (`b5a2cf9` и formal binding, `steps/walk-methods-t4b.md`, harness 400/400, дифф 216/216). Класс 3 (own-поле во вложенном теле) — после D-78. Throws и callable-формалы ждут своего места.
