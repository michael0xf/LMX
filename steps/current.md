...
- Новый вход в существующую задачу Codex: [CODEX_INBOUND.md](../claude_chat/CODEX_INBOUND.md). Клиент реализован, активная доставка INBOUND-ACTIVE-52916 проверена; пробуждение из idle ещё проверяется. Это уточняет прежнее ограничение ниже.
