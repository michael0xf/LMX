...
- [28. Mix: активные метки и интервалы](#mix)
- [29. WorldWideMix: адреса, ячейки и навигация](#worldwide)
- [30. Координация префиксов и зеркала](#mix-coordination)
- [31. HTTP и границы сервиса](#transport)
- [32. Идентификация, полномочия и свидетельства](#authentication)
- [33. Криптографические значения и провайдеры](#crypto-values)
- [34. Контракты криптографических операций](#crypto-operations)
...
<a id="mix"></a>
## 28. Mix: активные метки и интервалы
...
<a id="worldwide"></a>
## 29. WorldWideMix: адреса, ячейки и навигация
...
## 30. Координация префиксов и зеркала
...
## 32. Идентификация, полномочия и свидетельства
...
## 34. Контракты криптографических операций
