...
5. **T4b** — классы 1–3 ПОСАЖЕНЫ (`b5a2cf9`, formal binding, класс 3 `steps/walk-methods-t4b.md`, harness 401/401, дифф 191/191). Класс 3: own-поле во вложенном теле и свидетель связывания внутри ветки (ANSWER 201b2af-2). Throws и callable-формалы ждут своего места. **Следующий код — п.6** (mixed numeric types), если нет тикета.
